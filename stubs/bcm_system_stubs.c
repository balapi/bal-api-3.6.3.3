...
/* The following arrays are required in order to keep linker happy */
const bcmolt_enum_val bcmolt_obj_id_string_table[] = {BCMOLT_ENUM_LAST};
const bcmolt_enum_val bcmolt_interface_state_string_table[] = {BCMOLT_ENUM_LAST};
