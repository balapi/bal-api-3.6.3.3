...
typedef enum
{
    BCMOLT_TARGET__BEGIN = 1,
    BCMOLT_TARGET_GENERIC = 1, /**< Generic policer (flow, etc.) */
    BCMOLT_TARGET_PORT = 2, /**< port policer */
    BCMOLT_TARGET__NUM_OF, /**< Constant to use for sizing arrays - note that enum may have holes. */
} bcmolt_target;
...
typedef enum
{
    ...
    BCMOLT_TRAFFIC_TYPE_BROADCAST = 0, /**< L2 Broadcast (DMAC=FF:FF:FF:FF:FF) */
    BCMOLT_TRAFFIC_TYPE_UNICAST = 1, /**< L2 Unicast (DMAC MSB=0) */
    BCMOLT_TRAFFIC_TYPE_UNK_UNICAST = 2, /**< L2 Unicast where the DMAC is not found (DLF) */
    BCMOLT_TRAFFIC_TYPE_MULTICAST = 3, /**< L2 Multicast  (DMAC MSB=0x01) */
...
typedef enum
{
    ...
    BCMOLT_API_GROUP_ID_ERPS_INTERFACE_PORT_UPDATE_COMPLETE = 35, /**< ERPS Interface - erps port update completed. */
...
#define bcmolt_classifier_id_full_mask 0x7FFFF
...
#define bcmolt_flow_send_eth_packet_data_id_full_mask 0x3
...
typedef enum
{
    ...
    BCMOLT_POLICER_PROFILE_CFG_DATA_ID_TARGET = 2, /**< target. */
...
#define bcmolt_policer_profile_cfg_data_id_target BCMOLT_POLICER_PROFILE_CFG_DATA_ID_TARGET
